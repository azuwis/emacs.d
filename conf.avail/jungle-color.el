...
(defun color-theme-jungle ()
      ...
      (color-theme-install
       '(color-theme-jungle
         ...
         (show-paren-match-face ((t (:background "#3a3a3a"))))
         ...
         (font-lock-builtin-face ((t (:foreground "#d78700"))))
         (font-lock-comment-face ((t (:foreground "#585858")))) ; original inkpot: #cd8b00
         (font-lock-constant-face ((t (:foreground "#506dbd"))))
         (font-lock-doc-face ((t (:foreground "#cd8b00"))))
         (font-lock-function-name-face ((t (:bold t :foreground "#afaf00"))))
         (font-lock-keyword-face ((t (:bold t :foreground "#d78700"))))
         (font-lock-preprocessor-face ((t (:foreground "309090"))))
         (font-lock-reference-face ((t (:bold t :foreground "#808bed"))))
         (font-lock-string-face ((t (:foreground "#5fd700"))))
         (font-lock-type-face ((t (:bold t :foreground "#d75f00"))))
